...
```{r fig1, echo=TRUE, fig.cap="Tukey's HSD Results for Age vs. Group"}
...
```{r fig2, echo=TRUE, fig.cap="Tukey's HSD Results for Age vs. CDR"}
...
```{r fig3, echo=TRUE, fig.cap="Tukey's HSD Results for MMSE vs. Group"}
...
```{r fig4, echo=TRUE, fig.cap="Linear Regression Results By Group"}
